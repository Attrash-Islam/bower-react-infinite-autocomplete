...
/***/ function(module, exports, __webpack_require__) {
	...
	var infinite_autocomplete_1 = __webpack_require__(/*! infinite-autocomplete */ 32);
	var es6_promise_1 = __webpack_require__(/*! es6-promise */ 33);
	/**
	 * InfinityAutoComplete React Component
	 * @extends React.Component
	 * @author Islam Attrash
	 */
	var InfinityAutoComplete = (function (_super) {
	    __extends(InfinityAutoComplete, _super);
	    /**
	     * InfinityAutoComplete Component constructor
	     * @param props
	     */
	    function InfinityAutoComplete(props) {
	        return _super.call(this, props) || this;
	    }
	    /**
	     * componentDidMount lifecycle hook
	     */
	    InfinityAutoComplete.prototype.componentDidMount = function () {
	        this.plugin = new infinite_autocomplete_1.InfiniteAutocomplete(this.baseElement);
	        this.init();
	    };
	    /**
	     ...
	     */
	    InfinityAutoComplete.prototype.setData = function (data) {
	     ...
	     */
	    InfinityAutoComplete.prototype.setFetchSize = function (fetchSize) {
	        this.plugin.setConfig({
	            fetchSize: fetchSize
	        });
	    };
	     ...
	     */
	    InfinityAutoComplete.prototype.setMaxHeight = function (maxHeight) {
	        this.plugin.setConfig({
	            maxHeight: maxHeight
	        });
	    };
	     ...
	     */
	    InfinityAutoComplete.prototype.setCustomizedInput = function (customizedInput) {
	        this.plugin.setConfig({
	     ...
	     */
	    InfinityAutoComplete.prototype.setCustomizedOptions = function (customizedOptions) {
	        this.plugin.setConfig({
	     ...
	     * initializing method
	     */
	    InfinityAutoComplete.prototype.init = function () {
	        var _this = this;
	        if (this.props.data) {
	            ...
	            this.plugin.setConfig({
	                onSelect: function (element, data) {
	                    if (_this.props.onSelect) {
	                        _this.props.onSelect(element, data);
	                    }
	                }
	            });
	        }
	        if (this.props.getDataFromApi) {
	            this.plugin.setConfig({
	                getDataFromApi: function (text, page, fetchSize) {
	                    if (_this.props.getDataFromApi) {
	                        return _this
	                            .props
	                            .getDataFromApi(text, page, fetchSize);
	                    }
	                    else {
	                        return new es6_promise_1.Promise(function (resolve) { return resolve; });
	                    }
	                }
	            });
	        }
	     ...
	     */
	    InfinityAutoComplete.prototype.componentWillReceiveProps = function (nextProps) {
	     ...
	     */
	    InfinityAutoComplete.prototype.componentWillUnmount = function () {
	        this.plugin.destroy();
	    };
	    /**
	     * Render method
	     * @returns string
	     */
	    InfinityAutoComplete.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", { ref: function (base) { return _this.baseElement = base; } });
	    };
	    return InfinityAutoComplete;
	}(React.Component));
	exports.InfinityAutoComplete = InfinityAutoComplete;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function attemptVertx() {
	  try {
	    var r = require;
	    var vertx = __webpack_require__(/*! vertx */ 34);
