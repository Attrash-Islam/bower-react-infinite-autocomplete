...
export { InfinityAutoComplete };

declare class InfinityAutoComplete extends React.Component<IInfinityAutoCompleteParams, {}> {
    
}


interface IInfinityAutoCompleteParams extends InfiniteAutocompleteConfigParams {
